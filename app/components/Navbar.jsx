...
function Navbar() {
  ...
  return (
    <nav className="flex justify-between bg-color3 dark:bg-color2 text-color1 dark:text-color4 px-24 py-5 items-center">
      ...
      <div className="w-full px-16 text-sm">
        <ul className="flex justify-evenly text-center">
          ...
          <li className="nav-item dropdown">
            ...
            >
              <Link href="#" className="block hover:bg-color4 dark:hover:bg-color1 rounded p-2">
                Research Experience
              </Link>
              <Link href="#" className="block hover:bg-color4 dark:hover:bg-color1 rounded p-2">
